...
public class NotificationService {
    ...
    public void notifyBookingCreated(Booking booking) {
        ...
        logger.info("New booking created: Hotel {}, Guest {}, Room {}, Check-in: {}",
                booking.getHotelId(),
...
//            request.setMethod(com.sendgrid.Method.POST);  // Full class name
    ...
    private String buildEmailContent(Booking booking) {
        return String.format("""
            ...
            """,
                ...
                booking.getCreatedAt() != null ? booking.getCreatedAt() : "N/A"
        );
    }
}